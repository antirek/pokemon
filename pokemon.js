...
pokemon = function(text, link, options) {
  var component, css, html, id, style;
  if (text && link) {
    html = '<div class="pokemonBlock"> <a href="@pokemonHref" target="_blank"> <div id="@pokemonId"> <img src="https://media.giphy.com/media/S7nfK9JIe0meA/giphy.gif"> </div> </a> </div>';
    if (!options) {
      options = {};
    }
    ...
    html = html.replace('@pokemonHref', link).replace('@pokemonId', id);
